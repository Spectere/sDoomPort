...
void T_LightFlash(think_t* flash);
void P_SpawnLightFlash(sector_t* sector);
void T_StrobeFlash(think_t* flash);
...
void T_VerticalDoor(think_t* door);
...
void T_MoveCeiling(think_t* ceiling);
...
void T_MoveFloor(think_t* floor);
